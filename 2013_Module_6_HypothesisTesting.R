...
#                                                    #
# ================================================== #
# By the end of it - you should know which hypothesis testing model you should be testing. Common tests are 1-sample t-tests, or 2-sample tests; or paired sample t-tests. 
# There are some very common kinds of tests. 
# Z-Tests: Compares a sample mean with a normal dist. i.e. what is the probablity that this samplie lies near the mean of the distr. 
